...
void setupLedFlash(int pin) {
  ...
  const int resolution = 8; // Resolução do PWM em bits
  const int channel = 0;    // Canal do PWM

  ledcSetup(channel, freq, resolution); // Configura o canal do PWM
  ledcAttachPin(pin, channel);          // Associa o canal ao pino especificado
#else
